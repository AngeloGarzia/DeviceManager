    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/setup", "/api/setup/**").hasRole(Roles.SUPER_ADMIN)
                        .requestMatchers("/api/logs", "/api/logs/**").hasRole(Roles.SUPER_ADMIN)
                        ...
                        .requestMatchers("/api/visites-quadri", "/api/visites-quadri/**")
                            .hasAnyRole(Roles.ADMIN, Roles.TECHNICIEN)
                        .requestMatchers("/api/arrets-maintenance", "/api/arrets-maintenance/**")
                            .hasAnyRole(Roles.ADMIN, Roles.TECHNICIEN)
                        ...
                        .requestMatchers("/api/interventions", "/api/interventions/**")
                            .hasAnyRole(Roles.ADMIN, Roles.TECHNICIEN)
                        .requestMatchers("/api/interventions-techniques", "/api/interventions-techniques/**")
                            .hasAnyRole(Roles.ADMIN, Roles.TECHNICIEN)
                        .requestMatchers("/api/fit", "/api/fit/**")
                            .hasAnyRole(Roles.ADMIN, Roles.TECHNICIEN)
